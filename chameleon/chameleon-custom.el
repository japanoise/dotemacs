...
(custom-set-variables
 ...
 '(ansi-color-names-vector ["#242728" "#ff0066" "#63de5d" "#E6DB74" "#06d8ff"
                            "#ff8eff" "#53f2dc" "#f8fbfc"])
 ...
 '(highlight-tail-colors (quote (("#424748" . 0)
                                 ("#63de5d" . 20)
                                 ("#4BBEAE" . 30)
                                 ("#1DB4D0" . 50)
                                 ("#9A8F21" . 60)
 ...
 '(package-selected-packages (quote (htmlize dockerfile-mode srefactor fghsahusehue
                                             haskell-mode doom-themes rainbow-mode go-rename
                                             rainbow-delimiters memoize all-the-icons emojify
                                             monokai-theme diff-hl helm-projectile neotree
                                             markdown-mode smartparens smartparens-config
                                             web-mode smart-tabs-mode smart-tabs highlight-chars
                                             flycheck which-key undo-tree delight projectile
                                             dashboard page-break-lines whitespace-cleanup-mode
                                             org-bullets helm)))
 ...
 '(vc-annotate-color-map (quote ((20 . "#ff0066")
                                 (40 . "#CF4F1F")
                                 (60 . "#C26C0F")
                                 (80 . "#E6DB74")
                                 (100 . "#AB8C00")
 ...
 '(when (or (not (boundp (quote ansi-term-color-vector)))
