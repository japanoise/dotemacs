...
(deftheme xemacs-chameleon "xemacs theme - chameleon's changes")

(custom-theme-set-faces 'xemacs-chameleon
                        ...
                        '(font-lock-constant-face ((t (:foreground "DarkOrchid"))))
                        ...
                        '(font-lock-variable-name-face ((t (:foreground "magenta3"))))
                        ...
                        '(helm-M-x-key ((t (:foreground "medium blue" :background "gray65"
                                                        :underline t))))
                        ...
                        '(helm-source-header ((t (:family "Sans Serif" :height 1.3
                                                          :weight bold
                                                          :foreground "black"))))
                        ...
                        '(mode-line-inactive ((t (:background "white"
                                                              ...
                                                              :inverse-video nil
                                                              :box (:line-width 1 :color "black"
                                                                                :style released-button):slant
                                                                                italic))))
                        '(modeline ((t (:background "Gray85"))))
                        '(modeline-buffer-id ((t (:foreground "blue4"))))
                        '(modeline-mousable ((t (:foreground "firebrick"))))
                        ...
                        '(rainbow-delimiters-unmatched-face ((t (:background "black" :foreground "red"
                                                                             :weight bold))))
